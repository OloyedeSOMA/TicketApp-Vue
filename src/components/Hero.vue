<template>
  <section
    class="relative min-h-screen flex flex-col justify-center items-center overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-purple-50"
    aria-labelledby="hero-title"
  >
    <!-- Background Circles -->
    <div class="absolute top-32 left-1/2 -translate-x-1/2 w-[35rem] h-[35rem] bg-indigo-400 rounded-full blur-3xl opacity-40"></div>
    <div class="absolute top-12 right-0 w-[25rem] h-[25rem] bg-indigo-400 rounded-full blur-3xl opacity-35 translate-x-1/3"></div>

    
    <div class="relative z-10 text-center px-4">
      <h1
        id="hero-title"
        class="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-6"
      >
        Ticket Manager Pro
      </h1>
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <router-link
          to="/signup"
          class="px-8 py-3 rounded-xl bg-white text-indigo-600 font-medium border-2 border-indigo-600 hover:bg-indigo-50 transition-colors"
        >
          Get Started
        </router-link>
      </div>
